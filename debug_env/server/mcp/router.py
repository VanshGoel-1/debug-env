...
Handles MCP protocol messages for the debug-env tools.
Tool execution routes are at /mcp (no /api prefix).
"""
...
from debug_env.server.handlers.mcp_handler import handle_mcp_request
